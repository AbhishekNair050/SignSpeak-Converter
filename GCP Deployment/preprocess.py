...
gloss_mapping_path = "assets/gloss_mapping.json"
index_gloss_mapping_path = "assets/index_gloss_mapping.json"
index_label_mapping_path = "assets/index_label_mapping.json"
...
range_positive = np.load("assets/range_positive.npy")
range_negative = np.load("assets/range_negative.npy")
